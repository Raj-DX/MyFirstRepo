sap.ui.define([
    ...
    "dxc/fin/ar/rajvansh01/util/formatter",
    "sap/ui/model/Filter",
    ...
    MessageBox, Fragment) {
    'use strict';
    return BaseController.extend("dxc.fin.ar.rajvansh01.controller.Add",{
        formatter: Formatter,
        onInit: function(){
            ...
            this.oLocalModel.setData({
                "productData": {
                            ...
                            "Description" : "Notebook Professional 15 with 2,80 GHz quad core",
